...
def _render_exact_window_visual_cockpit(
    ...
    render_exact_window_visual_cockpit(
        context,
        selection,
        oos_scatter_figure=_oos_scatter_figure,
        metric_heatmap_figure=_metric_heatmap_figure,
        rss_bar_figure=_rss_bar_figure,
        window_timeline_figure=_window_timeline_figure,
        coverage_timeline_figure=_coverage_timeline_figure,
        st_module=st,
    )
...
def _render_exact_window_rejects_tab(
    ...
    render_exact_window_rejects_tab(
        context,
        selection,
        reject_reason_frame=_reject_reason_frame,
        st_module=st,
    )
