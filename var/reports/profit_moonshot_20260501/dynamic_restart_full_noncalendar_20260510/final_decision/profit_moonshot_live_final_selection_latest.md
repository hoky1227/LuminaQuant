...
- generated_at_utc: `2026-05-10T11:30:04.613905Z`
...
| `candidate_portfolio` | `fresh_portfolio_validation_return_risk_weight_fresh_pair_resid_revert_spread_lb24_z150_h120_sc10_st100_tp400_all__fresh_pair_resid_revert_spread_lb24_z150_h72_sc10_st100_tp240_asiaus` | 1.000000 | `True` | `True` | `state_signal` | `True` | `False` | 6.597083 | 0.0782% | 0.0536% | 1.457889 | 0 |  | `False` |
...
| `candidate_portfolio` | `fresh_portfolio_validation_drawdown_budget_fresh_pair_resid_revert_spread_lb24_z150_h120_sc10_st100_tp400_all__fresh_pair_resid_revert_spread_lb24_z150_h72_sc10_st100_tp240_asiaus` | 2.536309 | `False` | `True` | `state_signal` | `True` | `False` | 6.475738 | 0.1983% | 0.1359% | 1.458338 | 0 |  | `False` |
...
- under_8gib: `True`
- `artifact_memory_summary` `1`: max_rss_mib=`263.184`, under_8gib=`True`
- `artifact_memory_summary` `2`: max_rss_mib=`56.461`, under_8gib=`True`
- `artifact_memory_summary` `3`: max_rss_mib=`56.773`, under_8gib=`True`
- `artifact_memory_summary` `4`: max_rss_mib=`71.562`, under_8gib=`True`
- `time_log` `var/reports/profit_moonshot_20260501/dynamic_restart_full_noncalendar_20260510/replay_time.log`: max_rss_mib=`288.621`, under_8gib=`True`
- `time_log` `var/reports/profit_moonshot_20260501/dynamic_restart_full_noncalendar_20260510/tuning_time.log`: max_rss_mib=`270.043`, under_8gib=`True`
- `time_log` `var/reports/profit_moonshot_20260501/dynamic_restart_full_noncalendar_20260510/candidate_hybrid_time.log`: max_rss_mib=`252.457`, under_8gib=`True`
