...
- generated_at_utc: `2026-05-10T11:30:04.437843Z`
...
- name: `None`
- TV score: ``
- allocator train/validation/OOS return: `+0.0000%` / `+0.0000%` / `+0.0000%`
- replay train return/MDD: `+0.0000%` / `+0.0000%`
- replay validation return/MDD: `+0.0000%` / `+0.0000%`
- replay OOS return/MDD: `+0.0000%` / `+0.0000%`
- replay OOS return/MDD ratio: ``
- replay OOS Sharpe/Sortino/Calmar: `` / `` / ``
- liquidation counts train/validation/OOS: `0 / 0 / 0`
- minimum margin buffer train/validation/OOS: `` / `` / ``
- minimum margin ratio train/validation/OOS: `` / `` / ``
