...
Generated: `2026-05-03T11:08:51.311843Z`
...
|---:|---|---|---|---:|---:|---:|---:|---:|---|
| 1 | `profit_moonshot_leadlag_slow_diffusion_ensemble_mode` | `ready_for_live_equivalent_backtest` | alpha | n/a | +0.00% | 0.0000 | +0.00% | 0/0 | status_not_validated:ready_for_live_equivalent_backtest;legacy_train_val_mdd_gate_failed;train_trade_count_below_min;val_trade_count_below_min;val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
...
- train/val raw-first materialized coverage preflight는 `1`개 alpha mode에서 통과했다. 아직 `--execute-backtests`를 실행하지 않았으므로 readiness는 엔진 검증 대기 상태이며 selection evidence는 아니다.
