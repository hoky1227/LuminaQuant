...
Generated: `2026-05-06T10:06:17.663776Z`
...
|---:|---|---|---|---:|---:|---:|---:|---:|---|
| 1 | `profit_moonshot_hourly_shock_reversion_eth_12h_funding_guard_mode` | `ready_for_live_equivalent_backtest` | alpha | n/a | +0.00% | 0.0000 | +0.00% | 0/0 | status_not_validated:ready_for_live_equivalent_backtest;legacy_train_val_mdd_gate_failed;train_trade_count_below_min;val_trade_count_below_min;val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
| 2 | `profit_moonshot_hourly_shock_reversion_eth_12h_mode` | `ready_for_live_equivalent_backtest` | alpha | n/a | +0.00% | 0.0000 | +0.00% | 0/0 | status_not_validated:ready_for_live_equivalent_backtest;legacy_train_val_mdd_gate_failed;train_trade_count_below_min;val_trade_count_below_min;val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
| 3 | `profit_moonshot_precious_metal_pair_aggressive_mode` | `blocked_missing_raw_first_market_data` | alpha | n/a | +0.00% | 0.0000 | +0.00% | 0/0 | status_not_validated:blocked_missing_raw_first_market_data;legacy_train_val_mdd_gate_failed;train_trade_count_below_min;val_trade_count_below_min;val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
...
- `1`개 live portfolio mode는 아직 train/val raw-first materialized coverage가 부족해서 `blocked_missing_raw_first_market_data` 상태다.
