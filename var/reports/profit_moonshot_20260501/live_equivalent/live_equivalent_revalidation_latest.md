...
Generated: `2026-05-01T10:22:23.492458Z`
...
- Best full-universe live-equivalent candidate: `profit_moonshot_trend_mode`
...
|---:|---|---|---|---:|---:|---:|---:|---:|---|
| 1 | `profit_moonshot_trend_mode` | `live_equivalent_validated` | yes | 11.7471 | +0.01% | 0.0167 | +0.03% | 228/6 | BTC/USDT,ETH/USDT,BNB/USDT,SOL/USDT,TRX/USDT |
| 2 | `profit_moonshot_adaptive_momentum_mode` | `live_equivalent_validated` | yes | 10.6293 | +0.26% | 0.0124 | +0.75% | 356/52 | BTC/USDT,ETH/USDT,BNB/USDT,SOL/USDT,TRX/USDT |
| 3 | `profit_moonshot_breakout_mode` | `live_equivalent_validated` | alpha | 11.7999 | +0.00% | 0.0000 | +0.00% | 6/0 | train_trade_count_below_min;val_trade_count_below_min;val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
| 4 | `profit_moonshot_balanced_mode` | `live_equivalent_validated` | alpha | 11.5769 | -0.01% | -0.0102 | +0.04% | 777/112 | val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
| 5 | `profit_moonshot_reversion_mode` | `live_equivalent_validated` | alpha | 11.3546 | -0.03% | -0.0166 | +0.13% | 567/106 | val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
| 6 | `profit_reboot_compression_breakout_mode` | `live_equivalent_validated` | alpha | 8.6155 | -1.03% | -0.1142 | +1.04% | 144/38 | val_total_return_not_positive;val_sharpe_not_positive;val_sortino_not_positive |
...
- `2`개 mode가 live-equivalent engine backtest와 profit alpha gate를 모두 통과했다. selection eligibility는 양(+)의 validation return/Sharpe/Sortino와 active MDD/trade/liquidation gate 통과 후보에만 부여한다.
