...
- Source report: `/home/hoky/Quants-agent/LuminaQuant/var/reports/exact_window_backtests/followup_status/autonomous_cross_asset_liquidation_contagion_fade_5m_anchor_latest.json`
- Fit split: `val`
- Report split: `oos`
- Clusters: 3
...
| 4 | liquidation_contagion_fade_5m_balanced_ls_64_1.2 | CrossAssetLiquidationContagionFadeStrategy | mean_reversion | 5m | 10.00% | 0.000 | 0.00% | 0.000 | 0.00% |
