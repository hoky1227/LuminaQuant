...
- Source report: `/home/hoky/Quants-agent/LuminaQuant/var/reports/exact_window_backtests/followup_status/autonomous_funding_liquidation_crowding_fade_30m_anchor_latest.json`
- Fit split: `val`
- Report split: `oos`
- Clusters: 3
...
| 4 | funding_liquidation_crowding_fade_30m_balanced_ls_96_0.85 | FundingLiquidationCrowdingFadeStrategy | mean_reversion | 30m | 10.00% | 0.000 | 0.00% | 0.000 | 0.00% |
