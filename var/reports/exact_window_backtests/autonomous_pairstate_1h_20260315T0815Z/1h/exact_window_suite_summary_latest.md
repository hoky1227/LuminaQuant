...
| PairSpreadZScoreStrategy | pair_spread_1h_core_bnbusdt_trxusdt_2.6_0.70 | 1h | 11.996 | 0 | 0 | 11.06% | 7.010 |
| PerpCrowdingCarryStrategy | perp_crowding_carry_1h_0.45_0.15 | 1h | 0.000 | 0 | 0 | 0.00% | 0.000 |
| RegimeBreakoutCandidateStrategy | regime_breakout_1h_trend_ls_48_0.70 | 1h | 9.800 | 0 | 1 | 5.54% | 1.506 |
| RollingBreakoutStrategy | rolling_breakout_1h_guarded_ls_48_0.002 | 1h | 8.131 | 0 | 1 | -3.29% | -0.458 |
| TopCapTimeSeriesMomentumStrategy | topcap_tsmom_1h_balanced_16_4_0.015 | 1h | 3.719 | 0 | 0 | 3.24% | 1.464 |
...
| pair_spread_1h_core_bnbusdt_trxusdt_2.6_0.70 | PairSpreadZScoreStrategy | 16.84% | 11.06% | 7.010 |
| topcap_tsmom_1h_balanced_16_4_0.015 | TopCapTimeSeriesMomentumStrategy | 4.59% | 3.24% | 1.464 |
...
| rolling_breakout_1h_guarded_ls_48_0.002 | RollingBreakoutStrategy | 2.07% | -3.29% | -0.458 |

## Portfolio Monthly Hurdle

- 2026-02: return=1.24%, btc=-12.99%, threshold=2.00%, pass=False
