...
| CompositeTrendStrategy | composite_trend_stable_30m_stable_ls_core_ls_0.60_0.45_0.20_0.80 | 30m | 11.657 | 0 | 1 | 2.21% | 1.625 |
...
| MultiHorizonTrendExhaustionFadeStrategy | multi_horizon_trend_exhaustion_fade_30m_guarded_lo_24_2.0 | 30m | -10.525 | 0 | 0 | 0.09% | 0.890 |
| PairSpreadZScoreStrategy | pair_spread_30m_sector_btcusdt_trxusdt_2.0_0.50 | 30m | 10.102 | 0 | 1 | -5.26% | -4.848 |
| PerpCrowdingCarryStrategy | perp_crowding_carry_30m_0.25_0.08 | 30m | -0.001 | 0 | 0 | 0.06% | 2.417 |
| RegimeBreakoutCandidateStrategy | regime_breakout_30m_trend_ls_64_0.72 | 30m | 4.195 | 0 | 1 | 2.45% | 0.778 |
| RollingBreakoutStrategy | rolling_breakout_30m_guarded_ls_64_0.002 | 30m | 12.310 | 0 | 1 | 4.08% | 1.042 |
...
|---|---|---:|---:|---:|
| basis_snapback_reversion_30m_balanced_ls_96_1.8 | BasisSnapbackReversionStrategy | 24.99% | 0.00% | 0.000 |
| breadth_thrust_failure_reversal_30m_guarded_lo_24_0.85 | BreadthThrustFailureReversalStrategy | 24.99% | 0.00% | 0.000 |
| funding_liquidation_crowding_fade_30m_balanced_ls_96_0.85 | FundingLiquidationCrowdingFadeStrategy | 24.99% | 0.00% | 0.000 |
| perp_crowding_carry_30m_0.25_0.08 | PerpCrowdingCarryStrategy | 24.99% | 0.06% | 2.417 |
| multi_horizon_trend_exhaustion_fade_30m_guarded_lo_24_2.0 | MultiHorizonTrendExhaustionFadeStrategy | 0.04% | 0.09% | 0.890 |
