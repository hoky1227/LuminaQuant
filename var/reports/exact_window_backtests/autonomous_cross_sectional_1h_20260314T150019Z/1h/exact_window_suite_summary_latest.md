...
|---|---|---|---:|---:|---:|---:|---:|
| Alpha101FormulaStrategy | alpha101_formula_1h_a005_a005_vwap_tuned_dir | 1h | -16.185 | 0 | 0 | -15.98% | -6.943 |
| CompositeTrendStrategy | composite_trend_stable_1h_stable_lo_guarded_lo_0.75_0.60_0.25_0.95 | 1h | -6.378 | 0 | 0 | -0.19% | -2.855 |
| PairSpreadZScoreStrategy | pair_spread_1h_core_bnbusdt_trxusdt_2.6_0.70 | 1h | 12.061 | 0 | 0 | 11.06% | 7.010 |
| PerpCrowdingCarryStrategy | perp_crowding_carry_1h_0.45_0.15 | 1h | 0.000 | 0 | 0 | 0.00% | 0.000 |
| RegimeBreakoutCandidateStrategy | regime_breakout_1h_trend_ls_48_0.70 | 1h | 9.842 | 0 | 1 | 5.54% | 1.506 |
| RollingBreakoutStrategy | rolling_breakout_1h_guarded_ls_48_0.002 | 1h | 8.211 | 0 | 1 | -3.29% | -0.458 |
| TopCapTimeSeriesMomentumStrategy | topcap_tsmom_1h_balanced_16_4_0.015 | 1h | 3.732 | 0 | 0 | 3.24% | 1.464 |
...
| pair_spread_1h_core_bnbusdt_trxusdt_2.6_0.70 | PairSpreadZScoreStrategy | 17.20% | 11.06% | 7.010 |
| topcap_tsmom_1h_balanced_16_4_0.015 | TopCapTimeSeriesMomentumStrategy | 4.40% | 3.24% | 1.464 |
| alpha101_formula_1h_a005_a005_vwap_tuned_dir | Alpha101FormulaStrategy | 3.94% | -15.98% | -6.943 |
| regime_breakout_1h_trend_ls_48_0.70 | RegimeBreakoutCandidateStrategy | 2.32% | 5.54% | 1.506 |
| rolling_breakout_1h_guarded_ls_48_0.002 | RollingBreakoutStrategy | 2.14% | -3.29% | -0.458 |

## Portfolio Monthly Hurdle

- 2026-02: return=1.30%, btc=-12.99%, threshold=2.00%, pass=False
