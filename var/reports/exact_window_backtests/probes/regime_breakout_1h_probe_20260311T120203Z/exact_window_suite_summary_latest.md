...
|---|---|---|---:|---:|---:|---:|---:|
| RegimeBreakoutCandidateStrategy | regime_breakout_1h_long_window_ls_60_0.74 | 1h | 16.484 | 0 | 1 | 2.65% | 0.860 |
...
|---|---|---:|---:|---:|
| regime_breakout_1h_long_window_ls_60_0.74 | RegimeBreakoutCandidateStrategy | 100.00% | 2.65% | 0.860 |

## Portfolio Monthly Hurdle

- 2026-02: return=7.00%, btc=-12.99%, threshold=2.00%, pass=True
- 2026-03: return=-4.06%, btc=3.40%, threshold=3.40%, pass=False
