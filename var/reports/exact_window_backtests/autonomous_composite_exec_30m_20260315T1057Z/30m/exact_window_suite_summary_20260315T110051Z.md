...
|---|---|---|---:|---:|---:|---:|---:|
| CompositeTrendStrategy | composite_trend_stable_30m_stable_ls_core_ls_0.60_0.45_0.20_0.80 | 30m | 11.755 | 0 | 1 | 2.21% | 1.625 |
...
| RegimeBreakoutCandidateStrategy | regime_breakout_30m_trend_ls_64_0.72 | 30m | 4.221 | 0 | 1 | 2.45% | 0.778 |
| RollingBreakoutStrategy | rolling_breakout_30m_guarded_ls_64_0.002 | 30m | 12.420 | 0 | 1 | 4.08% | 1.042 |
...
| rolling_breakout_30m_guarded_ls_64_0.002 | RollingBreakoutStrategy | 11.75% | 4.08% | 1.042 |
| regime_breakout_30m_trend_ls_64_0.72 | RegimeBreakoutCandidateStrategy | 9.53% | 2.45% | 0.778 |
| mean_reversion_std_30m_balanced_ls_48_1.80 | MeanReversionStdStrategy | 8.72% | -13.13% | -2.855 |

## Portfolio Monthly Hurdle

- 2026-02: return=1.11%, btc=-12.99%, threshold=2.00%, pass=False
- 2026-03: return=-0.46%, btc=3.40%, threshold=3.40%, pass=False
